    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tituloEditorial', models.CharField(max_length=200, unique=True, verbose_name='Título')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tituloEtiquetaLibro', models.CharField(max_length=100, unique=True, verbose_name='Nombre de la nueva etiqueta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tituloGeneroLibro', models.CharField(max_length=200, unique=True, verbose_name='Título')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tituloLibro', models.CharField(help_text='Ingrese el nombre del género (p. ej. Ciencia Ficción, Poesía Francesa etc.)', max_length=200, unique=True, verbose_name='Titulo')),
                ...
                ('ISBNLibro', models.CharField(help_text='13 Caracteres <a href="https://www.isbn-international.org/content/what-isbn">ISBN number</a>', max_length=20, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Evite colocar su mismo nombre', max_length=50, unique=True, verbose_name='Nombre de Usuario')),
                ('nombreUsuario', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nombre')),
                ('apellidosUsuario', models.CharField(blank=True, max_length=100, null=True, verbose_name='Apellidos')),
                ('DNIUsuario', models.CharField(blank=True, help_text='8 digitos, incluya el cero adelante si fuese necesario. Especifique cuando no sea DNI', max_length=20, null=True, verbose_name='Documento de Identidad')),
                ('email', models.EmailField(max_length=50, verbose_name='Email')),
                ('direccionUsuario', models.CharField(blank=True, help_text='Incluya Distrito , Provincia y Pais si fuese necesario', max_length=250, null=True, verbose_name='Direccion')),
                ('imagenUsuario', models.ImageField(blank=True, max_length=200, null=True, upload_to='perfil/', verbose_name='Imagen de Perfil')),
                ('sexoUsuario', models.CharField(blank=True, choices=[('m', 'Masculino'), ('f', 'Femenino')], default='m', help_text='Seleccione el sexo del usuario', max_length=1, verbose_name='Sexo')),
                ('telefonoUsuario', models.CharField(blank=True, help_text='Ingresar un numero de celular con su codigo de pais y si es telefono con su codigo respectivo sin guiones o paréntesis', max_length=20, null=True, verbose_name='Telefono (Fijo o Movil)')),
                ('fechaNacimientoUsuario', models.DateField(blank=True, help_text='Formato d-mm-yyyy', null=True, verbose_name='Fecha de Nacimiento')),
                ('fechaCreacionUsuario', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Fecha de Creación')),
                ('tipoAdministradorUsuario', models.BooleanField(default=False, verbose_name='Administrador')),
                ('estadoUsuario', models.BooleanField(default=True, verbose_name='Activo')),
            ],
            options={
                'abstract': False,
            },
